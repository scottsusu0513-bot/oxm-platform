...
export const SUB_INDUSTRY_SEO_CONTENT: Record<string, {
  ...
  "chemical-manufacturing/cosmetic-odm": {
    ...
    description: "在 OXM 尋找台灣保養品、化妝品 OEM / ODM 代工廠商，ISO 22716 GMP 認證，自有品牌快速上市，直接詢價。",
  ...
  "food/beverage-oem": {
    ...
    description: "在 OXM 尋找台灣飲料、機能飲品 OEM 代工廠商，HACCP 認證，PET 瓶、鋁罐、軟袋各式包材，直接詢價。",
  ...
  "textile/apparel-manufacturing": {
    ...
    description: "在 OXM 尋找台灣成衣、服飾 OEM 代工廠商，打版打樣到量產，品牌自有設計接單，小量 MOQ 可配合。",
