...
export const INDUSTRY_SEO_CONTENT: Record<string, { intro: string; applications: string; howToChoose: string }> = {
  ...
  "工業設備／機械": {
    ...
    howToChoose: "選擇工業設備與機械代工廠時，應確認廠商的機械設計能力（是否有 SolidWorks/AutoCAD 工程師）；自動化整合的控制系統熟悉度（PLC、伺服、視覺）；對目標產業製程的理解深度；以及售後維修與備品供應的服務承諾。建議提供產線現況與改善目標，讓廠商評估整合方案後再進行規格確認。",
  },
};
...
export const SUB_INDUSTRY_SEO_CONTENT: Record<string, {
  ...
  "metal-processing/cnc-machining": {
    title: "CNC精密加工代工｜台灣金屬工廠推薦｜OXM",
    description: "尋找台灣 CNC 精密加工代工廠，五軸加工、車床、銑床 OEM 服務，公差精準，直接詢價比較。",
  ...
  "metal-processing/sheet-metal": {
    title: "鈑金加工代工｜台灣金屬工廠推薦｜OXM",
    description: "台灣鈑金加工廠推薦，雷射切割、折彎、衝孔一條龍，工業零件 OEM 接單，直接詢價。",
  ...
  "metal-processing/mold-making": {
    ...
    description: "台灣模具製造代工廠推薦，塑膠射出模、壓鑄模、沖壓模設計開發，快速打樣，直接詢價。",
  ...
  "plastic/plastic-injection": {
    title: "塑膠射出成型代工｜台灣塑膠工廠推薦｜OXM",
    description: "台灣塑膠射出成型代工廠，外殼零件開模打樣，ABS、PC、PP 各材質，OEM / ODM 接單。",
    intro: "台灣塑膠射出成型代工廠具備從模具設計開發到大量生產的一站式能力，使用材料涵蓋 ABS、PP、PC、PA（尼龍）、POM、TPU 等工程塑膠及彈性體，能依客戶需求選用食品級、阻燃（UL94）、抗靜電、耐高溫等特殊規格材料。射出噸位從 50T 到 1500T 不等，能生產從精密小件到大型外殼零件。",
    ...
    howToChoose: "選擇塑膠射出代工廠時，應確認廠商的噸位範圍能否覆蓋產品需求；是否提供模具設計（DFM）評估；廠商的材料管理是否嚴謹（防止混料）；後加工（噴漆、電鍍、絲印）是否一站完成；以及廠商對縮水、翹曲、毛邊等常見缺陷的改善能力。建議提供 3D 圖，要求試模後提供全尺寸量測報告。",
  },
  "electronics/pcb": {
    title: "PCB電路板代工｜台灣電子工廠推薦｜OXM",
    description: "台灣 PCB 電路板製造代工廠推薦，單雙面至多層板，快速打樣，OEM 量產服務，直接詢價。",
    ...
    howToChoose: "選擇 PCB 代工廠時，應確認廠商的最小線寬/線距能力；是否具備 IPC-A-600 外觀認證與 IPC-6012 性能認證；阻抗控制板的測試報告是否可提供；高頻材料的加工經驗；以及 AOI 全板測試是否為標準製程。快速打樣建議優先選擇線上報價系統完整的廠商，縮短溝通時間。",
  },
  "electronics/smt-assembly": {
    title: "SMT電子組裝代工｜台灣PCBA工廠推薦｜OXM",
    description: "台灣 SMT 電子組裝 PCBA 一站式代工，高速貼片、AOI 檢測、功能測試，OEM 彈性接單。",
    intro: "台灣 SMT 電子組裝代工廠具備高速 SMT 貼片機、回流焊、波峰焊、AOI 自動光學檢測及 ICT 測試等完整設備，能組裝從 01005 微型被動元件到 BGA、QFN 等細腳距 IC，提供 PCBA 一站式代工（PCB 製作＋零件採購＋SMT 組裝＋功能測試）。部分廠商具備 IPC-A-610 Class 3 認證，能服務醫療、航太等高可靠度應用。",
  ...
  "printing/packaging-print": {
    title: "包裝印刷代工｜台灣彩盒紙盒工廠推薦｜OXM",
    description: "台灣包裝印刷代工廠，彩盒、紙盒、包裝袋設計印刷一站式，燙金打凸 UV 後加工，直接詢價。",
    intro: "台灣包裝印刷代工廠具備從設計稿到成品的一站式服務，涵蓋平版膠印（CMYK+專色）、數位印刷、後加工（燙金、打凸、局部 UV、覆霧膜/光膜）及模切成型等完整製程。廠商能生產彩盒（天地蓋、插底、自鎖底）、紙盒（摺疊式、硬盒）、手提袋及軟袋等多種包裝形式，廣受美妝保養品、食品、電子產品及保健品牌採用。",
  ...
  "chemical-manufacturing/cosmetic-odm": {
    title: "保養品化妝品代工｜台灣OEM ODM工廠推薦｜OXM",
    description: "台灣保養品、化妝品 OEM / ODM 代工廠推薦，ISO 22716 GMP 認證，自有品牌快速上市，直接詢價。",
    intro: "台灣保養品與化妝品代工廠具備完整的 OEM/ODM 研發生產能力，多數廠商通過 ISO 22716 化妝品 GMP 認證，能依品牌配方需求或自主研發開發乳液、精華液、面膜、洗髮精、防曬品等多品項，並提供穩定性測試、防腐效能測試（PET）及皮膚刺激性測試等法規文件支援。台灣化妝品代工廠的優勢在於配方技術成熟、能快速客製打樣，且熟悉台灣、中國大陸、東南亞及歐美市場的法規要求。",
    ...
    howToChoose: "選擇保養品化妝品代工廠時，應確認廠商是否具備 ISO 22716 GMP 認證；配方保密協議（NDA）是否完善；是否提供穩定性測試與微生物檢驗報告；廠商對目標市場法規的熟悉程度；以及最低起訂量是否符合品牌初期規模。建議選擇具備小量打樣（如 50～100 件）能力的廠商，降低新品開發風險。",
  },
  "food/beverage-oem": {
    title: "飲料代工｜台灣飲品OEM工廠推薦｜OXM",
    description: "台灣飲料、機能飲品 OEM 代工廠推薦，HACCP 認證，PET 瓶、鋁罐、軟袋各式包材，直接詢價。",
    intro: "台灣飲料代工廠涵蓋機能飲料、茶飲、果汁、咖啡、氣泡飲及機能水等多元品類，多數廠商通過 HACCP 或 ISO 22000 食品安全認證，具備無菌充填（熱充填、冷充填、UHT）及各式包材（PET 瓶、鋁罐、鋁箔包、玻璃瓶、軟袋）的充填封蓋能力。台灣飲料 OEM 廠商普遍具備配方研發能力，能依品牌需求調整口味、甜度、功能性成分，協助品牌快速推出差異化產品。",
    ...
    howToChoose: "選擇飲料代工廠時，應確認廠商的充填設備類型（熱充填適合茶飲/果汁，冷充填適合含乳/低酸飲料）；HACCP/ISO 22000 認證有效期；最低起訂量；配方保密協議是否完善；以及廠商是否協助申請衛福部查驗登記。建議先進行小量打樣，確認口感、色澤與保存期限後再量產。",
  },
  "packaging/eco-packaging": {
    title: "環保包裝代工｜台灣永續包裝工廠推薦｜OXM",
    description: "台灣環保包裝代工廠推薦，FSC 認證紙材、PLA 生物基、紙漿模塑，符合歐美環保採購要求。",
    intro: "台灣環保包裝代工廠提供符合國際永續採購標準的包裝解決方案，涵蓋 FSC 認證再生紙盒、PLA 生物基塑膠、蔗渣漿塑模（紙漿模塑）、蜂窩紙緩衝材及可堆肥袋等環保材質。廠商多已取得 FSC 鏈監管認證（COC），能出具材料來源證明，符合歐盟、美國及日本零售通路的環保採購要求，適合品牌商推動 ESG 永續包裝升級。",
    ...
    howToChoose: "選擇環保包裝代工廠時，應確認廠商持有的環保認證（FSC COC、BPI 可堆肥、OK Compost）；是否能提供材料成分報告供品牌 ESG 揭露使用；環保材質的強度與保護性是否符合物流需求；以及成本溢價是否在預算範圍內（環保材質通常比傳統材質貴 15～30%）。建議要求廠商提供替換方案比較，評估環保升級的成本效益。",
  },
  "textile/apparel-manufacturing": {
    title: "成衣服飾代工｜台灣OEM工廠推薦｜OXM",
    description: "台灣成衣、服飾 OEM 代工廠推薦，打版打樣到量產，品牌自有設計接單，小量 MOQ 可配合。",
    ...
    howToChoose: "選擇成衣代工廠時，應確認廠商的打版師資歷與打版費用；是否具備目標認證（WRAP、GOTS 有機棉）；最低起訂量（MOQ）與每款顏色最低數量；面料採購的彈性（是否可客戶提供面料）；以及樣品製作週期與費用。建議先製作 Pre-Production Sample（PP 樣），確認版型、縫工與材質後再下量產訂單。",
  },
};
