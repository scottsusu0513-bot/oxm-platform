            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-1 min-w-0">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  ...
                  {factory.ownerName && (
                    <div className="flex items-center gap-2"><Building2 className="w-4 h-4 text-muted-foreground" /><span>負責人：{factory.ownerName}</span></div>
                  )}
                  {((factory as any).contactPersonName || factory.ownerName) && (
                    <div className="flex items-center gap-2"><Building2 className="w-4 h-4 text-muted-foreground" /><span>洽詢窗口：{(factory as any).contactPersonName || factory.ownerName}</span></div>
                  )}
