...
import {
  ...
  Megaphone, Newspaper, Pin, Gauge, Recycle,
...
export default function Home() {
  ...
  return (
    <NativePullToRefreshLayout contentRef={contentRef} indicatorRef={indicatorRef} iconRef={iconRef} phase={phase} className="min-h-screen bg-background animate-page-enter">
      ...
      {/* Footer 已搬到全域 Global Footer（client/src/components/Footer.tsx，
          由 App.tsx 的 FooterGate 掛載），這裡不再重複 render 一份，避免
          品牌／社群／Email／Terms／Privacy／copyright 內容出現兩份要維護。 */}
