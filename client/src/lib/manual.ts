...
export const MANUAL_ARTICLES: ManualArticle[] = [
...

  {
    ...
    keywords: ['搜尋', '工廠', '工作室', '關鍵字', 'ODM', 'OEM', '篩選', '條件', '類型', '代工模式', '產業', '地區', 'MOQ', '資本額', '收藏', '愛心', '聯繫工廠', '一鍵詢價', '批次詢價', '多間工廠'],
    isPopular: true,
    order: 1,
    status: 'ready',
    steps: [
...

  {
    ...
    keywords: ['刊登工廠', '刊登工作室', '免費刊登', '基本資料', '工廠名稱', '工作室名稱', '地址', '主產業', '子產業', 'OEM', 'ODM', '小量接單', '打樣', '建立工廠', '建立工作室', '送出審核', '修改資料', '工廠後台', '重新送審', '修改理由', '等待審核', '審核通過', '工廠上線', '前台資料'],
    isPopular: true,
    order: 1,
    status: 'draft',
    steps: [
