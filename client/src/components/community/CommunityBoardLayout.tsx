...
function BidsComingSoon() {
  return (
    <div className="py-24 text-center">
      <Gavel className="w-10 h-10 mx-auto mb-4 text-muted-foreground/40" />
      <p className="text-base font-semibold text-muted-foreground">競標區</p>
      <p className="text-sm text-muted-foreground/60 mt-1">功能開發中，敬請期待</p>
    </div>
  );
}
